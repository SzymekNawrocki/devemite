    ...
    <section className="py-24 overflow-hidden">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center text-accent">
          <div className="fade-in-up relative group">
          ...
          <div className="fade-in-up flex flex-col space-y-8">
            {title && (
              <div className="space-y-4">
                ...
                />
                <div className="animate-line-draw h-1 w-20 bg-gradient-to-r from-accent to-transparent"></div>
              </div>
            )}
